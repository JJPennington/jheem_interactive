...
{
    name = gsub('active and prior IDU', 'IDU', name, ignore.case = T)
    name = gsub('active IDU', 'IDU', name, ignore.case = T)
    name
}
...
{
    lumped = tpop
    lumped[,,,'IDU_in_remission'] = (lumped[,,,'active_IDU'] | lumped[,,,'IDU_in_remission'])
    lumped
}
