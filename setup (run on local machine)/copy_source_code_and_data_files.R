...
RESOURCE.DIR = 'shiny/resources/'
CODE.DIR = 'shiny/model_code/'
SRC.DIR = '../Ending_HIV'
...
file.copy(file.path(SRC.DIR, 'code/setup/base_parameters.R'), file.path(CODE.DIR, 'base_parameters.R'), overwrite = T)
...
file.copy(file.path(SRC.DIR, 'code/calibration/version_manager.R'), file.path(CODE.DIR, 'version_manager.R'), overwrite=T)
...
file.copy(file.path(SRC.DIR, 'code/interventions/systematic_intervention_sets.R'), file.path(CODE.DIR, 'systematic_intervention_sets.R'), overwrite=T)
